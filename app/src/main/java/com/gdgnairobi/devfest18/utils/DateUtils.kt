...
object DateUtils {
     ...
     */
    @JvmStatic
    private fun getTimeDifferenceInSeconds(dateString: String): Long {
     ...
     */
    @JvmStatic
    fun getPrettifiedTimeString(dateString: String): String {
        val time = getTimeDifferenceInSeconds(dateString)
